...
import './runtimeInit-BGxDdJgg.js';
import { R as React$1, _ as __mf_38, a as __mf_24, b as __mf_28, c as __mf_7 } from './host__loadShare__react__loadShare__.mjs-BnIB8v_e.js';
import{r as require$$0}from"./host__loadShare__react__loadShare__.mjs_commonjs-proxy-DvJ_xhh6.js";function getDefaultExportFromCjs(x) {
	return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}
import { r as require$$2 } from './host__loadShare__react_mf_2_dom__loadShare__.mjs_commonjs-proxy-BM1wgeTT.js';
import { _ as __vitePreload } from './preload-helper-CqoC6PUU.js';
import './host__loadShare__react_mf_2_dom__loadShare__.mjs-CIjTbw4V.js';
...
const RemoteCounter = React$1.lazy(() => __vitePreload(() => import('./host__loadRemote__remoteApp_mf_1_Counter__loadRemote__-BSSyLOdZ.js').then(n => n.h),true              ?[]:void 0));
const RemoteCard = React$1.lazy(() => __vitePreload(() => import('./host__loadRemote__remoteApp_mf_1_Card__loadRemote__-D_SK6pu-.js').then(n => n.h),true              ?[]:void 0));
const RemoteAnalytics = React$1.lazy(() => __vitePreload(() => import('./host__loadRemote__remoteApp2_mf_1_AnalyticsDashboard__loadRemote__-oluS9Bgk.js').then(n => n.h),true              ?[]:void 0));
const RemoteStoreModule = __vitePreload(() => import('./host__loadRemote__remoteApp_mf_1_Store__loadRemote__-C-KW6Kc4.js').then(n => n.h),true              ?[]:void 0);
const styles = {
  app: {
    minHeight: "100vh",
    display: "flex",
...
`;
const LoadingFallback = ({ label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.loadingContainer, children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.spinner }),
  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: styles.loadingText, children: [
    "Loading ",
    label,
    "…"
  ] })
...
class ErrorBoundary extends React$1.Component {
  ...
  render() {
    if (this.state.hasError) {
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.errorContainer, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: "2rem" }, children: "⚠️" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { style: styles.errorTitle, children: "Remote Component Error" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: styles.errorDesc, children: "Check if the remote is running at the expected port." }),
...
const App = () => {
  const [userName] = __mf_38("Demo User");
  const [initialCount] = __mf_38(10);
  const [lastCountData, setLastCountData] = __mf_38(null);
  const [lastCardAction, setLastCardAction] = __mf_38(null);
  const [lastRemoteMessage, setLastRemoteMessage] = __mf_38(null);
  const [dataLog, setDataLog] = __mf_38([]);
  const addLog = __mf_24(
    (direction, source, message, data) => {
      const entry = {
  ...
  const handleCountChange = __mf_24(
    (data) => {
      console.log(
  ...
  const handleCardAction = __mf_24(
    (data) => {
      console.log(
  ...
  const handleRemoteMessage = __mf_24(
    (data) => {
      console.log(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: extraKeyframes }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.app, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { style: styles.nav, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.logoArea, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.logoIcon, children: "⚡" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.logoText, children: "MFE Host" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...styles.statusPill, background: "rgba(251, 191, 36, 0.1)", borderColor: "rgba(251, 191, 36, 0.2)", color: "#fbbf24" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...styles.statusDot, background: "#fbbf24", boxShadow: "0 0 8px rgba(251, 191, 36, 0.5)" } }),
          "Sync Active"
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: styles.main, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.hero, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.heroPill, children: "🔄 Data Sharing Demo — React 19 + Vite Federation + TypeScript" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { style: styles.heroTitle, children: [
            "Cross-MFE",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Data Sharing"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: styles.heroSubtitle, children: [
            "Watch data flow between ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#6366f1" }, children: "Host" }),
            " and",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#a855f7" }, children: "Remote" }),
            " apps in real-time. Open",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#4ade80" }, children: "DevTools Console" }),
            " to see detailed logs."
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.statePanel, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.statePanelTitle, children: "🏠 Host State (sent to Remote as props)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.stateGrid, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.stateItem, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.stateLabel, children: "userName (→ Counter)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.stateValue, children: userName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.stateItem, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.stateLabel, children: "initialCount (→ Counter)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.stateValue, children: initialCount })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.stateItem, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.stateLabel, children: "Last Count from Remote" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: lastCountData ? lastCountData.count : "—"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.stateItem, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.stateLabel, children: "Last Card Action" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: lastCardAction ? `"${lastCardAction.title}"` : "—"
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.stateItem, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.stateLabel, children: "Last Remote Command" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                  ...
                  children: lastRemoteMessage ? `"${lastRemoteMessage.text}"` : "—"
                }
              )
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { ...styles.grid, gridTemplateColumns: "1fr 1fr", marginBottom: "4rem" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "2rem" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.sectionHeader, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.sectionLabel, children: "🕹️ Remote App 1: Interactivity" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.sectionLine })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(__mf_7, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, { label: "Counter" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              RemoteCounter,
              {
                initialCount,
                userName,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "2rem" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.sectionHeader, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.sectionLabel, children: "📊 Remote App 2: Analytics & Msg" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.sectionLine })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(__mf_7, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, { label: "Analytics Dashboard" }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              RemoteAnalytics,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.section, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.sectionHeader, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.sectionLabel, children: "🧩 Remote → Host (onAction callback)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.sectionLine })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorBoundary, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(__mf_7, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingFallback, { label: "Cards" }), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.grid, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              RemoteCard,
              {
                icon: "🚀",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.logPanel, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.logHeader, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.logTitle, children: "📋 Data Flow Log (see console for detailed output)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.logBody, children: dataLog.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles.logEmpty, children: 'No data exchanges yet. Click the counter buttons or card "Explore" to see data flow.' }) : dataLog.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.logEntry, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: styles.logTime, children: entry.time }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: styles.logMessage, children: [
              ...
              entry.message,
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#555570" }, children: entry.data })
            ] })
          ] }, entry.id)) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { style: styles.footer, children: [
        "Module Federation Demo · React ",
        React$1.version,
        " · TypeScript · Built with Vite · Open DevTools Console 🔍"
      ] })
    ] })
  ] });
};
